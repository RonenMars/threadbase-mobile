...
- [x] **Step 3: Implement the minimal harness changes**
...
- [x] **Step 1: Write failing workflow and runner behavior tests**
...
- [x] **Step 3: Implement the minimal workflow and runner branch**
...
- [x] **Step 1: Update the research status**
