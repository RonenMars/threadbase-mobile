...
| E2E | Mock Maestro suite — remaining flow failures + env gotchas | Open — 11/15 passing. [#598](https://github.com/RonenMars/threadbase-mobile/issues/598) (stale build) ✅ **CLOSED** — `ensure-release-build.js` now fails loudly instead of silently reusing a stale `.app` ([PR #626](https://github.com/RonenMars/threadbase-mobile/pull/626), `2de1c1ae`). [#600](https://github.com/RonenMars/threadbase-mobile/issues/600) (suite cannot gate) still open. See [e2e-remaining-work.md](./e2e-remaining-work.md) |
...
**Status re-verified 2026-08-11.** [#598](https://github.com/RonenMars/threadbase-mobile/issues/598) and [#599](https://github.com/RonenMars/threadbase-mobile/issues/599) are now closed — merged as [PR #626](https://github.com/RonenMars/threadbase-mobile/pull/626) (`2de1c1ae`) and [PR #625](https://github.com/RonenMars/threadbase-mobile/pull/625) (`4eb1ae54`). [#597](https://github.com/RonenMars/threadbase-mobile/issues/597) — the `threadbase://pair` deep link (see [ROADMAP.md](./ROADMAP.md) Feature 5) — is also closed, via [PR #627](https://github.com/RonenMars/threadbase-mobile/pull/627) (`24627baa`), confirmed on a real device (iPhone 17 Pro Max, iOS 26.1) on 2026-08-11, not just CI. Found while verifying it on-device: [#638](https://github.com/RonenMars/threadbase-mobile/issues/638) (P2, open — the pair-link failure screen shows a raw exception instead of translated copy). See [`followups/RELEASE-READINESS-2026-08-10.md`](./followups/RELEASE-READINESS-2026-08-10.md) for the full dated update, including a correction to how `ROADMAP.md` described Live Activities.
