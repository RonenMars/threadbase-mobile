...
Three judgment calls: #1092 vs #1085 `ServerStateMessage`; #1095 vs #1094 NowList; #1099 delete of unused `ServerErrorBanner` (INT lastError patch dies with it). #1100 vs #1095 NowList is mechanical twice: keep stale opacity, drop `quiet`, then drop `openQuietTail` while keeping #1095 deps. #1101 vs #1091 is mechanical: keep `cursor` / `CURSOR_PROVIDER` and switch colors to `PROVIDER_COLOR`. #1097/#1098 clean. Rest mechanical.
...
Ask before Flow C. Replay ledger 1 if #1092 is rebuilt; 8–16 if #1095; 17 if #1099; 18 and 24 if #1100; 19–23 if #1101. Keep excluding #952/#1039.
