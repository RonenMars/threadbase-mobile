...
**Branch:** `integration/2026-09-14-open-prs` — 2026-09-15 refresh plus stacked alerts through #1099 plus #1094 wait-duration unique
**CI:** not run on this branch. Local after #1094 wait-duration unique: lint + typecheck green. Unit 2239. Integration 522 / 71 suites. i18n 460 passed / 1 skipped. Scripts: 252 passed; `run-maestro` batch flake (isolated pass); `ci-lint-shards` red locally from gitignored `expo-env.d.ts` (host, not these PRs).
...
| What | Ref | SHA |
|---|---|---|
| Integration branch | `integration/2026-09-14-open-prs` | `eb761fb2` plus docs |
...
`#1088 unique → #1091 unique → #1092 → #1093 → #1094 → INT follow-up → #1095 → #1096 → INT follow-up → #1097 → #1098 → #1099 → INT follow-up → #1094 wait-duration unique`
