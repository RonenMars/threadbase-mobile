...
| [`add-provider`](add-provider/SKILL.md) | Adding a new agent CLI start chip (health, badges, filters). Live PTY and history live in streamer/scanner companion skills — edit all three together |
