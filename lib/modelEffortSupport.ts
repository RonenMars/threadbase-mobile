...
import { CODEX_CLI_PROVIDER, CURSOR_PROVIDER } from '@/constants/providers'
...
export function canSetModelEffort(
  ...
  if (session.provider === CODEX_CLI_PROVIDER || session.provider === CURSOR_PROVIDER) return false
